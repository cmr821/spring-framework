 ...
 * 用于解析包含Spring bean定义的XML文档的SPI。由{@link XmlBeanDefinitionReader}用于实际解析DoM文档。
 *
 ...
 *  <p>实例化每个文档解析:实现可以在执行{@code registerBeanDefinitions}方法&mdash期间在实例变量中保存状态;
 *  例如，为文档中的所有bean定义的全局设置。
 *
